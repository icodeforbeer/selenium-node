...
java -jar "$workingFolder\selenium-server-standalone-2.53.1.jar" -role node -port $port -nodeConfig $configFilePath -hub $hubUrl -D"webdriver.chrome.driver=drivers/chromedriver.exe" -D"webdriver.ie.driver=drivers/IEDriverServer.exe" -D"webdriver.firefox.driver=drivers/geckodriver.exe"
